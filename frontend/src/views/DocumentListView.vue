    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200/80 w-full">
      <div>
        <div class="flex items-center gap-2.5">
          ...
          <div>
            <h1 class="text-xl font-bold text-slate-800">Danh Mục Văn Bản & Quyết Định Chỉ Đạo</h1>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 w-full">
            ...
            >
              <div class="space-y-3">
                ...
                <h3 class="text-base font-bold text-slate-800 line-clamp-2 leading-snug group-hover:text-blue-600 transition">
                  {{ doc.name }}
                </h3>
